...
public class BeginInstallControlPanel extends AbstractControlPanel implements ActionListener {
	...
	public BeginInstallControlPanel() {
		try {
			jbInit();
		} catch (Exception ex) {
			ex.printStackTrace();
	...
	void jbInit() throws Exception {
		...
		this.btnNext.setText(I18nUtil.getString("BUTTON_INSTALL"));
