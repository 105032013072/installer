package com.bosssoft.platform.installer.io.util;
...
public class OS {
	...
	public static boolean isOs(String family, String name, String arch, String version) {
		...
		if ((family != null) || (name != null) || (arch != null) || (version != null)) {
			...
			if (family != null) {
				...
				boolean isNT = false;
				if (isWindows) {
					if ((OS_NAME.indexOf("95") < 0) && (OS_NAME.indexOf("98") < 0) && (OS_NAME.indexOf("me") < 0))
						;
					is9x = OS_NAME.indexOf("ce") >= 0;
					isNT = !is9x;
				}
	...
	public static boolean isMicroWindows() {
		return (isFamily("windows")) || (isFamily("win9x")) || (isFamily("winnt")) || (isFamily("dos"));
	}
}