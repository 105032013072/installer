...
public class StartWebSphere implements IAction {
	...
	public void execute(IContext context, Map parameters) throws InstallException {
		...
		context.setValue("DONE_START_WAS", "true");
	...
	private boolean isStarted(String profileName, String serverName, String userName, String password) {
		return WASScriptTool.isStarted(profileName, serverName, userName, password);
	}
