...
public class Registry {
	...
	public Registry(String dir) {
		...
		File regFile = new File(dir, registryFileName);
	...
	public void addInstalledProduct(IContext context) {
		...
		String eosVersion = context.getStringValue(PRODUCT_VEERSION);
		...
		try {
			XmlHelper.saveAs(this.dir + "/" + registryFileName, this.doc, "GB2312");
		} catch (IOException e) {
